...
const I18N = {
  fr:{
    ...
    'act.next':'Balayez vers la gauche pour la suivante',
    ...
    'inst.titleBureau':'Installer Curio sur cet ordinateur',
    'inst.bureau':'Dans la barre d\u2019adresse, l\u2019ic\u00f4ne d\u2019installation \u2014 ou le menu du navigateur, \u00ab Installer Curio \u00bb. Il s\u2019ouvre alors dans sa propre fen\u00eatre.',
    'inst.autre':'Le menu de votre navigateur propose d\u2019ajouter Curio \u00e0 l\u2019\u00e9cran d\u2019accueil.',
    'inst.cta':'Installer',
  ...
  en:{
    ...
    'act.next':'Swipe left for the next one',
    'acc.mode':'Hooks only',
    ...
    'inst.titleBureau':'Install Curio on this computer',
    'inst.bureau':'The install icon in the address bar \u2014 or your browser menu, \u201cInstall Curio\u201d. It then opens in its own window.',
    'inst.autre':'Your browser menu offers to add Curio to your home screen.',
    'inst.cta':'Install',
    'inst.later':'Later',
