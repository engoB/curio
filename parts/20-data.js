...
const I18N = {
  fr:{
    ...
    'inst.menu':'Installer l\u2019application',
    ...
    offreJour:n=>`<b>${n}</b><em> anecdote${n>1?'s':''} aujourd\u2019hui</em>`,
    unlimited:'Illimité',
    'accueil.ok':'Retour au début de la journée.',
    'find.more':n=>`… et ${n} autre(s). Précisez votre recherche.`,
    credit:(t,u)=>`Sujet : ${t}`,
  ...
  en:{
    ...
    offreJour:n=>`<b>${n}</b><em> wonder${n>1?'s':''} today</em>`,
    unlimited:'Unlimited',
    'accueil.ok':'Back to the top of today.',
    'find.more':n=>`… and ${n} more. Narrow your search.`,
