...
const CONFIG = {
  freeDaily: 10,
  // Le gratuit n'enferme personne dans deux univers : dix anecdotes par
  // jour, prises partout. C'est le nombre qui limite, pas le sujet.
...
const I18N = {
  fr:{
    ...
    'ob.note':'10 anecdotes offertes chaque jour. Aucune inscription requise.',
    ...
    'find.title':'Chercher un sujet','find.sub':"Un mot, un nom, un lieu — Curio remonte ce qu'il a de plus surprenant sur le sujet.",
    'find.go':'Chercher',
    ...
    'plan.freeTip':'10 anecdotes par jour, les 8 univers','plan.paidTip':'Lecture illimit\u00e9e',
    'plan.back':'Abonnement termin\u00e9 : retour \u00e0 10 anecdotes par jour. Votre collection est conserv\u00e9e.',
    ...
    'tease.body':"Vous avez lu vos 10 anecdotes du jour. Revenez demain, ou lisez sans compteur d\u00e8s maintenant.",
    'tease.cta':'Voir les tarifs',
    'tease.alt':'Revenir demain',
    'size.label':'Taille du texte',
    'act.keep':'Garder', 'act.share':'Partager',
    'act.next':'Faites d\u00e9filer pour la suivante',
    'inst.title':'Mettre Curio sur votre \u00e9cran d\u2019accueil',
    ...
    unlimited:'Illimité',
    credit:(t,u)=>`Sujet : ${t}`,
    'ob.source':"Chaque anecdote est écrite pour Curio à partir de faits vérifiés, puis relue avant publication.",
    lockTitle:'Cette anecdote fait partie de Curio Illimité',
    lockTitleQuota:'Vous avez lu vos 10 anecdotes du jour',
    lockBody:"Passez en lecture illimitée : plus de compteur, et toutes les nouveautés dès leur sortie.",
    lockBodyQuota:"Revenez demain pour 10 nouvelles anecdotes — ou continuez maintenant, sans limite.",
    ...
    activated:'Curio Illimité activé. Merci !', badkey:'Clé non reconnue.',
    picked:n=>`${n} univers actif${n>1?'s':''}`,
    plansTitle:{monthly:'Mensuel',yearly:'Annuel',lifetime:'À vie'},
    planTag:'Le meilleur rapport',
    planFeat:{
      monthly:['Lecture illimitée','Le sommaire et la recherche','Sans engagement'],
      yearly:['Lecture illimitée','Le sommaire et la recherche','Deux mois offerts'],
      lifetime:['Lecture illimitée, pour toujours','Toutes les anecdotes à venir','Aucun renouvellement','Un seul paiement']
    },
  ...
  en:{
    ...
    'ob.note':'10 free wonders every day. No sign-up.',
    ...
    'find.title':'Search a subject','find.sub':'A word, a name, a place — Curio brings back the most surprising thing it holds on the subject.',
    'find.go':'Search',
    ...
    'plan.freeTip':'10 pieces a day, all 8 universes','plan.paidTip':'Unlimited reading',
    'plan.back':'Subscription ended: back to 10 pieces a day. Your collection is kept.',
    ...
    'tease.body':'You have read your 10 pieces for today. Come back tomorrow, or read without a counter right now.',
    'tease.cta':'See the plans',
    'tease.alt':'Come back tomorrow',
    'size.label':'Text size',
    'act.keep':'Keep', 'act.share':'Share',
    'act.next':'Scroll for the next one',
    'inst.title':'Put Curio on your home screen',
    ...
    'ob.source':"Every piece is written for Curio from verified facts, then read again before it goes live.",
    lockTitle:'This piece is part of Curio Unlimited',
    lockTitleQuota:'You have read your 10 wonders for today',
    lockBody:'Go unlimited: no more counter, and every new piece the day it lands.',
    lockBodyQuota:'Come back tomorrow for 10 more — or keep going right now, without limits.',
    ...
    activated:'Curio Unlimited activated. Thank you!', badkey:'Key not recognised.',
    picked:n=>`${n} universe${n>1?'s':''} on`,
    plansTitle:{monthly:'Monthly',yearly:'Yearly',lifetime:'Lifetime'},
    planTag:'Best value',
    planFeat:{
      monthly:['Unlimited reading','Contents list and search','No commitment'],
      yearly:['Unlimited reading','Contents list and search','Two months free'],
      lifetime:['Unlimited reading, forever','Every piece still to come','No renewal','One single payment']
    },
