...
const FAQ = {
  fr:[
    ...
    ["Que contient la version gratuite ?",
     "Cinq anecdotes par jour, tirées au hasard dans les huit univers — aucun n'est fermé. Elles sont à vous pour la journée : le lendemain, cinq autres arrivent et les précédentes s'en vont. Sans compte, sans publicité."],
  ...
  en:[
    ...
    ["What is in the free version?",
     "Five pieces a day, drawn at random from all eight universes — none is closed off. They are yours for the day: tomorrow five others arrive and these are gone. No account, no ads."],
...
const TXT = {
  fr:{
    ...
    freeFeat:['5 anecdotes par jour, renouvelées chaque matin','Les 8 univers, aucun fermé','Sans compte, sans publicité'],
    planCta:{monthly:"S'abonner",yearly:"S'abonner",lifetime:'Acheter à vie'},
    feat:{
      monthly:['Lecture illimitée','La pioche : une anecdote au hasard','Ma collection, gardée pour toujours','Sans engagement'],
      yearly:['Lecture illimitée','La pioche : une anecdote au hasard','Ma collection, gardée pour toujours','Deux mois offerts'],
      lifetime:['Lecture illimitée, pour toujours','La pioche : une anecdote au hasard','Ma collection, gardée pour toujours','Un seul paiement']
    },
  ...
  en:{
    ...
    freeFeat:['5 pieces a day, renewed every morning','All 8 universes, none locked','No account, no ads'],
    planCta:{monthly:'Subscribe',yearly:'Subscribe',lifetime:'Buy lifetime'},
    feat:{
      monthly:['Unlimited reading','The draw: one piece at random','My collection, kept for good','No commitment'],
      yearly:['Unlimited reading','The draw: one piece at random','My collection, kept for good','Two months free'],
      lifetime:['Unlimited reading, forever','The draw: one piece at random','My collection, kept for good','One single payment']
    },
