...
const FAQ = {
  fr:[
    ...
    ["Le chiffre affiché en haut est-il réel ?",
     "Oui, et c'est important. Il compte les anecdotes réellement écrites et publiées, pas les sujets en attente. Le badge à côté indique combien sont arrivées cette semaine. Rien n'est saisi à la main."],
    ["Que contient la version gratuite ?",
     "Dix anecdotes par jour, prises dans les huit univers — aucun n'est fermé. La recherche, votre collection, la lecture hors ligne et le mode clair/sombre sont inclus. Sans compte, sans publicité."],
    ["Quelle différence entre l'abonnement et l'achat à vie ?",
     "L'abonnement se règle au mois ou à l'année et se résilie quand vous voulez, en un clic, depuis votre espace client. L'achat à vie est un paiement unique : il ouvre les huit univers pour toujours, y compris tout ce qui sera écrit après votre achat."],
    ["Si je m'abonne aujourd'hui, j'ai accès à tout ?",
     "Oui. Tout ce qui a déjà été publié, et tout ce qui le sera pendant votre abonnement. Une anecdote écrite ne disparaît jamais et n'est jamais réservée à ceux qui étaient là avant vous."],
    ["Est-ce que ça marche hors ligne ?",
     "Oui, et pour tout le monde. Curio garde l'application et les anecdotes que vous avez ouvertes : dans le métro ou en avion, elles restent lisibles. Rien à activer, rien à télécharger."],
    ["Faut-il installer une application ?",
     "Non, et c'est voulu. Curio s'ajoute à votre écran d'accueil comme une application — sur iPhone : le menu de partage, puis « Sur l'écran d'accueil » ; sur Android, le navigateur le propose de lui-même. Elle s'ouvre en plein écran, sans barre d'adresse, et fonctionne hors ligne. Rien à télécharger, rien à mettre à jour."],
    ["Puis-je proposer un sujet ?",
     "Volontiers, et les propositions des abonnés passent en premier. Écrivez-nous le sujet et pourquoi il vous a marqué — c'est la deuxième partie qui décide."]
  ],
  en:[
    ...
    ['Is the number at the top real?',
     "Yes, and that matters. It counts pieces actually written and published, not subjects queued up. The badge beside it shows how many arrived this week. Nothing is typed in by hand."],
    ['What is in the free version?',
     "Ten pieces a day, drawn from all eight universes — none is closed off. Search, your collection, offline reading and light/dark mode are included. No account, no ads."],
    ['Subscription or lifetime — what changes?',
     "The subscription is billed monthly or yearly and can be cancelled in one click from your customer area. Lifetime is a single payment: all eight universes, for good, including everything written after you buy."],
    ['If I subscribe today, do I get everything?',
     "Yes. Everything already published, and everything published while you subscribe. A piece once written never disappears and is never reserved for people who arrived before you."],
    ['Does it work offline?',
     "Yes, for everyone. Curio keeps the app and the pieces you have opened: on the underground or on a plane, they stay readable. Nothing to switch on, nothing to download."],
    ['Do I need to install an app?',
     "No, and that is deliberate. Curio adds itself to your home screen like an app — on iPhone: the share menu, then 'Add to Home Screen'; on Android the browser offers it for you. It opens full screen, with no address bar, and works offline. Nothing to download, nothing to update."],
    ['Can I suggest a subject?',
     "Please do, and subscriber suggestions go first. Send us the subject and why it stuck with you — the second part is what decides."]
  ]
};
...
const TXT = {
  fr:{
    ...
    r1:'10 anecdotes offertes chaque jour', r2:'Aucune inscription', r3:'Sans publicité',
    ...
    s2t:'Lisez', s2p:"Une anecdote par écran, deux minutes de lecture, un fond dessiné pour l'univers. Le texte a un début, un mécanisme et une chute — pas un résumé qui s'arrête au milieu.",
    ...
    uLead:"Les huit sont ouverts, dès la version gratuite. Ce qui change avec l'abonnement, c'est le compteur : dix par jour, ou autant que vous voulez.",
    ...
    freeFeat:['10 anecdotes par jour','Les 8 univers, aucun fermé','Lecture hors ligne','Ma collection','Sans compte, sans publicité'],
  ...
  en:{
    ...
    r1:'10 free wonders every day', r2:'No sign-up', r3:'No ads',
    ...
    s2t:'Read', s2p:'One piece per screen, two minutes of reading, a backdrop drawn for its universe. Each has an opening, a mechanism and a turn — not a summary that stops halfway.',
    ...
    uLead:'All eight are open, from the free version. What the subscription changes is the counter: ten a day, or as many as you like.',
    ...
    freeFeat:['10 pieces a day','All 8 universes, none locked','Offline reading','My collection','No account, no ads'],
...
function paintCount(){
  ...
  if(s2) s2.textContent = fr
    ? "Les huit sont ouverts, dès la version gratuite. Ce qui change avec l'abonnement, c'est le compteur : dix par jour, ou autant que vous voulez — et le sommaire, qui donne accès à tout d'un coup."
    : 'All eight are open, from the free version. What the subscription changes is the counter — ten a day, or as many as you like — and the contents list, which opens everything at once.';
}
